...
# authors_search GET    /authors/search(.:format)      authors#search
#  authors_hello GET    /authors/hello(.:format)       authors#hello
...
Reader::Application.routes.draw do
  ...
  post "authors/world" => "authors#world"

  resources :books
  # resources :searches, :only => [:index, :show]
  resources :searches, :except => :destroy
